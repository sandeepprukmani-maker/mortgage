...
try:
    ...
    # Update all customers' property_zip to 23266
    cursor.execute("UPDATE customer SET property_zip = '23266'")
    conn.commit()

    print(f"Successfully updated all {count} customers' property_zip to 23266")
