<template>
    <div class="col-xxl-4 col-sm-6">
        <div class="card radius-8 border-0 d-flex flex-column" style="height: 545px;">

        <div class="card-body d-flex flex-column h-100">
          <!-- Header -->
          <div class="d-flex align-items-center flex-wrap gap-2 justify-content-between mb-3">
            <h6 class="fw-bold text-lg">Distribution Maps</h6>
          ...
          <div class="scrollable-country-list">
            <div
              class="d-flex align-items-center justify-content-between gap-3 mb-3 pb-2"
              ...
              <div class="d-flex align-items-center gap-2 w-100">
                <div class="w-100 max-w-66 ms-auto">
                  <div
                    ...
                    aria-valuemax="100"
                  >
                    <div class="progress-bar" :class="country.progressColor" :style="{ width: country.progress + '%' }"></div>
                  </div>
                </div>
...
.world-map {
  height: 300px; /* or any height you want for the map */
  min-height: 200px;
  width: 100%;
  border-radius: 8px;
  position: relative;
