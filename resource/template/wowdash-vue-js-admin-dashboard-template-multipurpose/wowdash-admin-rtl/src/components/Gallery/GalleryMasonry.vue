        ...
        <div class="card-body p-24">
            <div class="masonry-wrapper">
                <div v-for="(img, index) in images" :key="index"
                    class="hover-scale-img border radius-16 overflow-hidden p-8">
                    <a href="#" class="popup-img w-100 h-100 d-flex radius-12 overflow-hidden"
                        @click.prevent="openModal(img, index % images.length)">
    ...
    data() {
        return {
            ...
            images: [
                ...
                { src: galleryImg1, alt: 'Image 13' },
                { src: galleryImg2, alt: 'Image 14' },
                { src: galleryImg3, alt: 'Image 15' },
                { src: galleryImg4, alt: 'Image 16' },
                { src: galleryImg5, alt: 'Image 17' },
                { src: galleryImg6, alt: 'Image 18' },
                { src: galleryImg7, alt: 'Image 19' },
                { src: galleryImg8, alt: 'Image 20' },
                { src: galleryImg9, alt: 'Image 21' },
                { src: galleryImg10, alt: 'Image 22' },
                { src: galleryImg11, alt: 'Image 11' },
                { src: galleryImg12, alt: 'Image 12' }
            ]
        }
