            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    ...
                    <div class="card-body p-16">
                        ...
                        <p class="card-text text-neutral-600">We quickly learn to fear and thus automatically
                            avo id potentially stressful situations of all kinds, including the most common of
                            all .</p>
                        <a href="javascript:void(0)"
                            class="btn text-primary-600 hover-text-primary px-0 py-10 d-inline-flex align-items-center gap-2">
                            Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl">
                            </iconify-icon>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-xxl-3 col-sm-6">
                <div class="card h-100 radius-12">
                    <div class="card-body p-24">
                        ...
                        <p class="card-text mb-8 text-secondary-light">Random Text gateway to the Origin al the
                            Works Platform, & your unique block chain gateway identity.</p>
                        <a href="javascript:void(0)"
                    ...
                    <div class="card-body p-0 gradient-overlay bottom-0 start-0">
                        ...
                        <div class="position-absolute start-0 bottom-0 p-24 z-1">
                         ...
                         text-lg mb-6">This is Card title</h5>
                            <p class="card-text text-white">We quickly learn to fear and thus automatically avo
                                id potentially stressful situations of all kinds, including the most common of
                                all</p>
                            <a href="javascript:void(0)"
                                class="btn text-primary-600 hover-text-primary px-0 py-10 d-inline-flex align-items-center gap-2">
                                Read More <iconify-icon icon="iconamoon:arrow-right-2" class="text-xl">
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card radius-12 h-100">
                    ...
                    <div class="card-body py-16 px-24">
                        ...
                        <p class="card-text text-neutral-600 mb-0">Intrinsically incubate intuitive
                            opportunities and real-time potentialities for change for interoperable meta-itself
            ...
            <div class="col-xxl-4 col-sm-6">
                <div class="card radius-12 h-100">
                    <div class="card-body py-16 px-24">
                        ...
                        <p class="card-text text-neutral-600 mb-16">Intrinsically incubate intuitive
                            opportunities and real-time potentialities for change for interoperable meta-itself
                            the viewer's attention from the layout</p>
                        <p class="card-text text-neutral-600 mb-0">Intrinsically incubate intuitive
                            opportunities and real-time potentialities for change for interoperable </p>
                        <a href="javascript:void(0)"
        ...
        <div class="row gy-4">
            <div class="col-xl-6">
                <div class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="@/assets/images/card-component/horizontal-card-img1.png"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
                        <p class="card-text text-neutral-600 mb-16">We quickly learn to fear and thus
                            automatically avo id potentially stressful situations of all kinds, including the
                            most common of all .</p>
                        <a href="javascript:void(0)"
            ...
            <div class="col-xl-6">
                <div
                    ...
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="@/assets/images/card-component/horizontal-card-img2.png"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
            ...
            <div class="col-xl-6">
                <div class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="@/assets/images/card-component/horizontal-card-img3.png"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
            ...
            <div class="col-xl-6">
                <div
                    class="card radius-12 overflow-hidden h-100 d-flex align-items-center flex-nowrap flex-row flex-row-reverse">
                    <div class="d-flex flex-shrink-0 w-170-px h-100">
                        <img src="@/assets/images/card-component/horizontal-card-img4.png"
                            class="h-100 w-100 object-fit-cover" alt="">
                    </div>
                    <div class="card-body p-16 flex-grow-1">
                        <h5 class="card-title text-lg text-primary-light mb-6">This is Card title</h5>
